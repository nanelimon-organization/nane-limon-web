...
export const members = [
    ...
    },
    {
      ...
      description:
        "Tarık Kaan Koç, 2024 yılında Yazılım Mühendisliği bölümünden mezun olmuştur. Akademik yolculuğu, yapay zeka alanına derin bir odaklanma ile şekillenmiştir. Profesyonel alanda, bankacılık ve pazarlama sektörlerinde müşteri memnuniyetini artırmada önemli katkılarda bulunmuştur. Önemli başarıları arasında, Türk Havacılık ve Uzay Sanayii'nde (TUSAŞ) LIFT UP programında kritik teknoloji haberlerini ayrıştıran bir yapay zeka algoritması geliştirmek ve ulusal yapay zeka yarışmalarında (Teknofest TDDI vb.) birincilik dereceleri kazanmak bulunmaktadır. Yarışmaların ötesinde, 200'den fazla mühendislik öğrencisine veri bilimi ve makine öğrenimi konularında eğitim vermiştir. Gerçek dünya senaryolarında yenilikçi teknolojilerin, özellikle Üretken Yapay Zeka Büyük Dil Modelleri ve Doğal Dil İşleme (NLP) alanlarında uygulanmasına tutku duymaktadır ve takım çalışması, yaratıcılık ve çeşitliliğe büyük önem vermektedir.",
